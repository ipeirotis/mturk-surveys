...
@XmlRootElement(name = "QuestionForm", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd")
public class QuestionForm {

    @XmlElements({
        @XmlElement(name = "Overview", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd", type = ContentType.class),
        @XmlElement(name = "Question", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd", type = Question.class)
    })
