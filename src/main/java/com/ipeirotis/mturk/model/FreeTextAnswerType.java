...
@XmlType(name = "FreeTextAnswerType", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd", propOrder = {
    "constraints",
    "defaultText",
...
public class FreeTextAnswerType {
    ...
    @XmlElement(name = "Constraints", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd")
    protected Constraints constraints;
    @XmlElement(name = "DefaultText", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd")
    protected String defaultText;
    @XmlElement(name = "NumberOfLinesSuggestion", namespace = "http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2005-10-01/QuestionForm.xsd")
