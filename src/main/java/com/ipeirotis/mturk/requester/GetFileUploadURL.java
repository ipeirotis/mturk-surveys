 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetFileUploadURLRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetFileUploadURL")
public class GetFileUploadURL {
    ...
    protected List<GetFileUploadURLRequest> request;
     ...
     * 
     */
    public List<GetFileUploadURLRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetFileUploadURLRequest>();
        }
        return this.request;
    }
