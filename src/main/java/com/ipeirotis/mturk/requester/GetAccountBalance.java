 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetAccountBalanceRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAccountBalance {
    ...
    protected List<GetAccountBalanceRequest> request;
     ...
     * 
     */
    public List<GetAccountBalanceRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetAccountBalanceRequest>();
        }
        return this.request;
    }
