 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetQualificationsForQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetQualificationsForQualificationType")
public class GetQualificationsForQualificationType {
    ...
    protected List<GetQualificationsForQualificationTypeRequest> request;
     ...
     * 
     */
    public List<GetQualificationsForQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetQualificationsForQualificationTypeRequest>();
        }
        return this.request;
    }
