...
/**
 * <p>Java class for GetBlockedWorkersResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetBlockedWorkersResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="WorkerBlock" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}WorkerBlock" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetBlockedWorkersResult", propOrder = {
    "request",
    "pageNumber",
    "numResults",
    "totalNumResults",
...
public class GetBlockedWorkersResult {
    ...
    @XmlElement(name = "WorkerBlock")
    protected List<WorkerBlock> workerBlock;
    ...
    /**
     * Gets the value of the workerBlock property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the workerBlock property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWorkerBlock().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<WorkerBlock> getWorkerBlock() {
        if (workerBlock == null) {
            workerBlock = new ArrayList<WorkerBlock>();
        }
        return this.workerBlock;
    }
