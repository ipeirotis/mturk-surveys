 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetAssignmentRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAssignment")
public class GetAssignment {
    ...
    protected List<GetAssignmentRequest> request;
     ...
     * 
     */
    public List<GetAssignmentRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetAssignmentRequest>();
        }
        return this.request;
    }
