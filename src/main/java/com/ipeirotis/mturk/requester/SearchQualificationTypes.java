 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}SearchQualificationTypesRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SearchQualificationTypes")
public class SearchQualificationTypes {
    ...
    protected List<SearchQualificationTypesRequest> request;
     ...
     * 
     */
    public List<SearchQualificationTypesRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SearchQualificationTypesRequest>();
        }
        return this.request;
    }
