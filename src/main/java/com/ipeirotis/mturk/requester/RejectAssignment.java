 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}RejectAssignmentRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RejectAssignment")
public class RejectAssignment {
    ...
    protected List<RejectAssignmentRequest> request;
     ...
     * 
     */
    public List<RejectAssignmentRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<RejectAssignmentRequest>();
        }
        return this.request;
    }
