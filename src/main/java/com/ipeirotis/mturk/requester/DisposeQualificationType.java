 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}DisposeQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DisposeQualificationType")
public class DisposeQualificationType {
    ...
    protected List<DisposeQualificationTypeRequest> request;
     ...
     * 
     */
    public List<DisposeQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<DisposeQualificationTypeRequest>();
        }
        return this.request;
    }
