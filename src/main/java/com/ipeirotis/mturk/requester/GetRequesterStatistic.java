 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetRequesterStatisticRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRequesterStatistic")
public class GetRequesterStatistic {
    ...
    protected List<GetRequesterStatisticRequest> request;
     ...
     * 
     */
    public List<GetRequesterStatisticRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetRequesterStatisticRequest>();
        }
        return this.request;
    }
