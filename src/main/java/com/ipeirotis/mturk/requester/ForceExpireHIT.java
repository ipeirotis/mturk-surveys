 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}ForceExpireHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ForceExpireHIT")
public class ForceExpireHIT {
    ...
    protected List<ForceExpireHITRequest> request;
     ...
     * 
     */
    public List<ForceExpireHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<ForceExpireHITRequest>();
        }
        return this.request;
    }
