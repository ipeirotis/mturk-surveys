 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}SendTestEventNotificationRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SendTestEventNotification")
public class SendTestEventNotification {
    ...
    protected List<SendTestEventNotificationRequest> request;
     ...
     * {@link SendTestEventNotificationRequest }
     * 
     * 
     */
    public List<SendTestEventNotificationRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SendTestEventNotificationRequest>();
        }
        return this.request;
    }
