 ...
 *         &lt;element name="GetAccountBalanceResult" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetAccountBalanceResult" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetAccountBalanceResponse {
    ...
    protected List<GetAccountBalanceResult> getAccountBalanceResult;
     ...
     * This is why there is not a <CODE>set</CODE> method for the getAccountBalanceResult property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGetAccountBalanceResult().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<GetAccountBalanceResult> getGetAccountBalanceResult() {
        if (getAccountBalanceResult == null) {
            getAccountBalanceResult = new ArrayList<GetAccountBalanceResult>();
        }
