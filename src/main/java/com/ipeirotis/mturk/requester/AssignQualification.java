 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}AssignQualificationRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "AssignQualification")
public class AssignQualification {
    ...
    protected List<AssignQualificationRequest> request;
     ...
     * 
     */
    public List<AssignQualificationRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<AssignQualificationRequest>();
        }
        return this.request;
    }
