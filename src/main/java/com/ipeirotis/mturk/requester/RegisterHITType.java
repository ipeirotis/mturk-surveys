 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}RegisterHITTypeRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RegisterHITType")
public class RegisterHITType {
    ...
    protected List<RegisterHITTypeRequest> request;
     ...
     * 
     */
    public List<RegisterHITTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<RegisterHITTypeRequest>();
        }
        return this.request;
    }
