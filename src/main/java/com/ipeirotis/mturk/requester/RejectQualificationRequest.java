 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}RejectQualificationRequestRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RejectQualificationRequest")
public class RejectQualificationRequest {
    ...
    protected List<RejectQualificationRequestRequest> request;
     ...
     * 
     */
    public List<RejectQualificationRequestRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<RejectQualificationRequestRequest>();
        }
        return this.request;
    }
