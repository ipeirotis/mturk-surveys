 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}BlockWorkerRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "BlockWorker")
public class BlockWorker {
    ...
    protected List<BlockWorkerRequest> request;
     ...
     * 
     */
    public List<BlockWorkerRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<BlockWorkerRequest>();
        }
        return this.request;
    }
