 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}ApproveAssignmentRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ApproveAssignment")
public class ApproveAssignment {
    ...
    protected List<ApproveAssignmentRequest> request;
     ...
     * 
     */
    public List<ApproveAssignmentRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<ApproveAssignmentRequest>();
        }
        return this.request;
    }
