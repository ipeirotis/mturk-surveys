 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}SetHITAsReviewingRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetHITAsReviewing")
public class SetHITAsReviewing {
    ...
    protected List<SetHITAsReviewingRequest> request;
     ...
     * 
     */
    public List<SetHITAsReviewingRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SetHITAsReviewingRequest>();
        }
        return this.request;
    }
