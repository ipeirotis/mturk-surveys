 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetBlockedWorkersRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetBlockedWorkers")
public class GetBlockedWorkers {
    ...
    protected List<GetBlockedWorkersRequest> request;
     ...
     * 
     */
    public List<GetBlockedWorkersRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetBlockedWorkersRequest>();
        }
        return this.request;
    }
