 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetRequesterWorkerStatisticRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRequesterWorkerStatistic")
public class GetRequesterWorkerStatistic {
    ...
    protected List<GetRequesterWorkerStatisticRequest> request;
     ...
     * 
     */
    public List<GetRequesterWorkerStatisticRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetRequesterWorkerStatisticRequest>();
        }
        return this.request;
    }
