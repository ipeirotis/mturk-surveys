 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}DisposeHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DisposeHIT")
public class DisposeHIT {
    ...
    protected List<DisposeHITRequest> request;
     ...
     * 
     */
    public List<DisposeHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<DisposeHITRequest>();
        }
        return this.request;
    }
