 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetHITsForQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetHITsForQualificationType")
public class GetHITsForQualificationType {
    ...
    protected List<GetHITsForQualificationTypeRequest> request;
     ...
     * 
     */
    public List<GetHITsForQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetHITsForQualificationTypeRequest>();
        }
        return this.request;
    }
