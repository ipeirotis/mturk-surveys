 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}RevokeQualificationRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RevokeQualification")
public class RevokeQualification {
    ...
    protected List<RevokeQualificationRequest> request;
     ...
     * 
     */
    public List<RevokeQualificationRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<RevokeQualificationRequest>();
        }
        return this.request;
    }
