 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}CreateHITRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CreateHIT {
    ...
    protected List<CreateHITRequest> request;
     ...
     * 
     */
    public List<CreateHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<CreateHITRequest>();
        }
        return this.request;
    }
