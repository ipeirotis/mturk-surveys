 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetQualificationType")
public class GetQualificationType {
    ...
    protected List<GetQualificationTypeRequest> request;
     ...
     * 
     */
    public List<GetQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetQualificationTypeRequest>();
        }
        return this.request;
    }
