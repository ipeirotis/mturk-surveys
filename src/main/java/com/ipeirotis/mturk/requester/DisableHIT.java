 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}DisableHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DisableHIT")
public class DisableHIT {
    ...
    protected List<DisableHITRequest> request;
     ...
     * 
     */
    public List<DisableHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<DisableHITRequest>();
        }
        return this.request;
    }
