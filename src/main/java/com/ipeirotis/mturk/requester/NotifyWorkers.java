 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}NotifyWorkersRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "NotifyWorkers")
public class NotifyWorkers {
    ...
    protected List<NotifyWorkersRequest> request;
     ...
     * 
     */
    public List<NotifyWorkersRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<NotifyWorkersRequest>();
        }
        return this.request;
    }
