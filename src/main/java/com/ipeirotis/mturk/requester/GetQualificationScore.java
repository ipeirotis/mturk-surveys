 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetQualificationScoreRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetQualificationScore")
public class GetQualificationScore {
    ...
    protected List<GetQualificationScoreRequest> request;
     ...
     * {@link GetQualificationScoreRequest }
     * 
     * 
     */
    public List<GetQualificationScoreRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetQualificationScoreRequest>();
        }
        return this.request;
    }
