 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}UpdateQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UpdateQualificationType")
public class UpdateQualificationType {
    ...
    protected List<UpdateQualificationTypeRequest> request;
     ...
     * 
     */
    public List<UpdateQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<UpdateQualificationTypeRequest>();
        }
        return this.request;
    }
