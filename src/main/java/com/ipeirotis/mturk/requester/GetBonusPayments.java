 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetBonusPaymentsRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetBonusPayments")
public class GetBonusPayments {
    ...
    protected List<GetBonusPaymentsRequest> request;
     ...
     * 
     */
    public List<GetBonusPaymentsRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetBonusPaymentsRequest>();
        }
        return this.request;
    }
