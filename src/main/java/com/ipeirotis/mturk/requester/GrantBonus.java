 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GrantBonusRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GrantBonus")
public class GrantBonus {
    ...
    protected List<GrantBonusRequest> request;
     ...
     * 
     */
    public List<GrantBonusRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GrantBonusRequest>();
        }
        return this.request;
    }
