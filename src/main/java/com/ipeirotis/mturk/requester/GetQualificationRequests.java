 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetQualificationRequestsRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetQualificationRequests")
public class GetQualificationRequests {
    ...
    protected List<GetQualificationRequestsRequest> request;
     ...
     * 
     */
    public List<GetQualificationRequestsRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetQualificationRequestsRequest>();
        }
        return this.request;
    }
