 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}ApproveRejectedAssignmentRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ApproveRejectedAssignment")
public class ApproveRejectedAssignment {
    ...
    protected List<ApproveRejectedAssignmentRequest> request;
     ...
     * 
     */
    public List<ApproveRejectedAssignmentRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<ApproveRejectedAssignmentRequest>();
        }
        return this.request;
    }
