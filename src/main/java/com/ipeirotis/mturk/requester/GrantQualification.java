 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GrantQualificationRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GrantQualification")
public class GrantQualification {
    ...
    protected List<GrantQualificationRequest> request;
     ...
     * 
     */
    public List<GrantQualificationRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GrantQualificationRequest>();
        }
        return this.request;
    }
