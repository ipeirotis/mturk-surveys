 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetAssignmentsForHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetAssignmentsForHIT")
public class GetAssignmentsForHIT {
    ...
    protected List<GetAssignmentsForHITRequest> request;
     ...
     * 
     */
    public List<GetAssignmentsForHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetAssignmentsForHITRequest>();
        }
        return this.request;
    }
