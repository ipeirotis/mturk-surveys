 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetReviewResultsForHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetReviewResultsForHIT")
public class GetReviewResultsForHIT {
    ...
    protected List<GetReviewResultsForHITRequest> request;
     ...
     * 
     */
    public List<GetReviewResultsForHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetReviewResultsForHITRequest>();
        }
        return this.request;
    }
