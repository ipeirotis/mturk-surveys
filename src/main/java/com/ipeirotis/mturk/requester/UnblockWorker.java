 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}UnblockWorkerRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "UnblockWorker")
public class UnblockWorker {
    ...
    protected List<UnblockWorkerRequest> request;
     ...
     * 
     */
    public List<UnblockWorkerRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<UnblockWorkerRequest>();
        }
        return this.request;
    }
