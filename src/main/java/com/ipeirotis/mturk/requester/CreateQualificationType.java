 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}CreateQualificationTypeRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "CreateQualificationType")
public class CreateQualificationType {
    ...
    protected List<CreateQualificationTypeRequest> request;
     ...
     * 
     */
    public List<CreateQualificationTypeRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<CreateQualificationTypeRequest>();
        }
        return this.request;
    }
