 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}SetHITTypeNotificationRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetHITTypeNotification")
public class SetHITTypeNotification {
    ...
    protected List<SetHITTypeNotificationRequest> request;
     ...
     * {@link SetHITTypeNotificationRequest }
     * 
     * 
     */
    public List<SetHITTypeNotificationRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SetHITTypeNotificationRequest>();
        }
        return this.request;
    }
