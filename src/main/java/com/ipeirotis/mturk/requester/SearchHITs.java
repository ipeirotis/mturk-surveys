 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}SearchHITsRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SearchHITs {
    ...
    protected List<SearchHITsRequest> request;
     ...
     * 
     */
    public List<SearchHITsRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<SearchHITsRequest>();
        }
        return this.request;
    }
