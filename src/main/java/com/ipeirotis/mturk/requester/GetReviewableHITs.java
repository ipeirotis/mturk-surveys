 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetReviewableHITsRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetReviewableHITs")
public class GetReviewableHITs {
    ...
    protected List<GetReviewableHITsRequest> request;
     ...
     * 
     */
    public List<GetReviewableHITsRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetReviewableHITsRequest>();
        }
        return this.request;
    }
