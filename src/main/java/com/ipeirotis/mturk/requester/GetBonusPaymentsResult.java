...
/**
 * <p>Java class for GetBonusPaymentsResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetBonusPaymentsResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="BonusPayment" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}BonusPayment" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "GetBonusPaymentsResult", propOrder = {
    "request",
    "numResults",
    "pageNumber",
    "totalNumResults",
...
public class GetBonusPaymentsResult {
    ...
    protected List<BonusPayment> bonusPayment;
    ...
    /**
     * Gets the value of the bonusPayment property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the bonusPayment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBonusPayment().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BonusPayment> getBonusPayment() {
        if (bonusPayment == null) {
            bonusPayment = new ArrayList<BonusPayment>();
        }
