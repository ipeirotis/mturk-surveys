 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}GetHITRequest" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetHIT {
    ...
    protected List<GetHITRequest> request;
     ...
     * 
     */
    public List<GetHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<GetHITRequest>();
        }
        return this.request;
    }
