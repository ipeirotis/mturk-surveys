 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}ChangeHITTypeOfHITRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ChangeHITTypeOfHIT")
public class ChangeHITTypeOfHIT {
    ...
    protected List<ChangeHITTypeOfHITRequest> request;
     ...
     * 
     */
    public List<ChangeHITTypeOfHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<ChangeHITTypeOfHITRequest>();
        }
        return this.request;
    }
