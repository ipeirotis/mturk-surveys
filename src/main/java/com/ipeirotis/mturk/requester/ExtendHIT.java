 ...
 *         &lt;element name="Request" type="{http://requester.mturk.amazonaws.com/doc/2013-11-15}ExtendHITRequest" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ExtendHIT")
public class ExtendHIT {
    ...
    protected List<ExtendHITRequest> request;
     ...
     * 
     */
    public List<ExtendHITRequest> getRequest() {
        if (request == null) {
            request = new ArrayList<ExtendHITRequest>();
        }
        return this.request;
    }
